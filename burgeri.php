...
<title>Restaurant Venus | Burgeri</title>
<style>
...
<div id="container_principal"> 
 ...
 <div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="images/burger1.jpg" style="width:100%;height:400px">
    <div class="text">Burger de pui</div>
  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="images/burger2.jpg" style="width:100%;height:400px">
    <div class="text">Burger vegetarian</div>
  </div>
 ...
 <div id="col2">
	<h1 class="text-center">Burgeri</h1>
